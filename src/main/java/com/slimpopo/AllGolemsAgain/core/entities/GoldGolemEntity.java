...
public class GoldGolemEntity extends IronGolemEntity {
    public static EntityType<?> GOLD_GOLEM = EntityType.Builder.create(GoldGolemEntity::new, EntityClassification.CREATURE).build(Constants.MOD_ID + ":gold_golem").setRegistryName(new ResourceLocation(Constants.MOD_ID, "gold_golem"));


    public GoldGolemEntity(EntityType<? extends IronGolemEntity> type, World worldIn) {
        super((EntityType<? extends IronGolemEntity>) GolemTypes.gold_golem, worldIn);
    }
     ...
     */
    public static boolean isValidSpawnPlacement(EntityType<GoldGolemEntity> wabbit, IWorld world, SpawnReason spawnReason, BlockPos pos, Random random) {
