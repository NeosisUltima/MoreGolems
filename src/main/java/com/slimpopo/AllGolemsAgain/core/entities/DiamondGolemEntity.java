...
public class DiamondGolemEntity extends IronGolemEntity{
    public static EntityType<?> DIAMOND_GOLEM = EntityType.Builder.create(DiamondGolemEntity::new, EntityClassification.CREATURE).build(Constants.MOD_ID + ":diamond_golem").setRegistryName(new ResourceLocation(Constants.MOD_ID, "diamond_golem"));


    public DiamondGolemEntity(EntityType<? extends IronGolemEntity> type, World worldIn) {
        super((EntityType<? extends IronGolemEntity>) GolemTypes.diamond_golem, worldIn);
    }
