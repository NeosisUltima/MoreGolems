...
public class StoneGolemEntity extends IronGolemEntity{
    public static EntityType<?> STONE_GOLEM = EntityType.Builder.create(StoneGolemEntity::new, EntityClassification.CREATURE).build(Constants.MOD_ID + ":stone_golem").setRegistryName(new ResourceLocation(Constants.MOD_ID, "stone_golem"));


    public StoneGolemEntity(EntityType<? extends IronGolemEntity> type, World worldIn) {
        super((EntityType<? extends IronGolemEntity>) GolemTypes.stone_golem, worldIn);
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(1, (new HurtByTargetGoal(this)).setCallsForHelp(StoneGolemEntity.class));
    ...
    protected void registerAttributes() {
        ...
        this.getAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(Math.random() * 8 + 5);
    }
     ...
     */
    public static boolean isValidSpawnPlacement(EntityType<StoneGolemEntity> wabbit, IWorld world, SpawnReason spawnReason, BlockPos pos, Random random) {
