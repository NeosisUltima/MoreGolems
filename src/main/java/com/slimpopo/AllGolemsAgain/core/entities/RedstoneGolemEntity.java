...
public class RedstoneGolemEntity extends IronGolemEntity {
    public static EntityType<?> REDSTONE_GOLEM = EntityType.Builder.create(RedstoneGolemEntity::new, EntityClassification.CREATURE).build(Constants.MOD_ID + ":redstone_golem").setRegistryName(new ResourceLocation(Constants.MOD_ID, "redstone_golem"));


    public RedstoneGolemEntity(EntityType<? extends IronGolemEntity> type, World worldIn) {
        super((EntityType<? extends IronGolemEntity>) GolemTypes.redstone_golem, worldIn);
    }
    ...
    protected void registerAttributes() {
        ...
        this.getAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(Math.random() * 5 + 2);
    }
     ...
     */
    public static boolean isValidSpawnPlacement(EntityType<RedstoneGolemEntity> wabbit, IWorld world, SpawnReason spawnReason, BlockPos pos, Random random) {
